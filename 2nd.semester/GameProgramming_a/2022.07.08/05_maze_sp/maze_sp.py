...
from move import Move               # Moveクラスのインポート
import random


map_list = [MAZE_MAP_1, MAZE_MAP_2, MAZE_MAP_3, MAZE_MAP_4, MAZE_MAP_5]
pos_list = [START_POS_1, START_POS_2, START_POS_3, START_POS_4, START_POS_5]
random_num = random.randint(0, 4)
maze_map = map_list[random_num]
my_pos = pos_list[random_num]
