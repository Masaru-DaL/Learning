...
作成したプログラムが**仕様どおりに動作するか、要求されている性能を満たしているか**を、漏れなく計画的に検証していく


## 品質を評価するための手法
### ベンチマーク
ハードウェアやプログラム(ソフトウェア)の処理能力を測るための手法
例えば、「あるデータの処理を3秒以内で完了し、画面に表示する」など、あらかじめ目的に応じた指標(ベンチマーク)を定めておき、その指標と比較・評価することで、性能を判断する

### 信頼度成長曲線
**バグ曲線**とも呼ばれる。

![picture 3](../../../images/d853424e431def94fc1824bc86d9ceb5e7b7f5b7799f33f04c8a658c4224ad57.png)
...
## プログラムの品質管理に用いる図法
### 管理図
![picture 4](../../../images/b722fdecfba33116b09e7e1c780e23fe8754343bb665f1eb1e9e053dfc19eded.png)

### 特性要因図
形状の特徴から、**魚骨図**や**フィッシュボーンチャート**とも呼ばれる。
![picture 5](../../../images/41a9f016ff61ea60f48a2a05b20db1964ee24bc39e6ef0fd1ec379ab6b20a62e.png)

### パレート図
![picture 6](../../../images/71f41c729ed49fedc600727f6d94f103e3898dd1a0a6fd7b4e588b1de1bcf0f5.png)

- 棒グラフ
  - 項目データ値の降順に並べたもの
- 線グラフ
  - 項目の累積値を表すもの
パレート図は上記2つのを1つのグラフ内にまとめて表現した複合グラフである。
※**複数の項目が占める割合(比率累計)を図上で示せるのはパレート図のみ！**
