...
[通信機能及び他の機器の管理機能をもつ高機能型の電力メータであるスマートメータを導入する目的として、適切でないものはどれか](https://www.fe-siken.com/bunya.php?m=21&s=1&no=2)
...
[頻繁に行う操作を効率よく行えるようにしたユーザインタフェースはどれか。](https://www.fe-siken.com/bunya.php?m=7&s=1&no=6)

[変形を感知するセンサを用いると、高架道路などの状態を監視してメンテナンスすることが可能である。この目的で使用されているセンサはどれか。](https://www.fe-siken.com/bunya.php?m=6&s=1&no=14)

[データベース管理システムを利用する目的はどれか。](https://www.itpassportsiken.com/bunya.php?m=21&s=1&no=8)

[関係データベースに関する記述中のa、bに入れる字句の適切な組合せはどれか。　関係データベースにおいて、レコード(行)を一意に識別するための情報を a と言い、表と表を特定の b で関連付けることもできる。](https://www.itpassportsiken.com/bunya.php?m=21&s=1&no=9)

[関係モデルとその実装である関係データベースの対応に関する記述のうち、適切なものはどれか。](https://www.fe-siken.com/bunya.php?m=9&s=1&no=3)

[関係データベースの説明として、適切なものはどれか。](https://www.fe-siken.com/bunya.php?m=9&s=1&no=15)
