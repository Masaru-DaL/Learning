...
- [ビジネス戦略と技術開発戦略](#ビジネス戦略と技術開発戦略)
  ...
  - [開発競争に負けない技術開発戦略](#開発競争に負けない技術開発戦略)
  - [技術開発計画で有効活用する開発投資](#技術開発計画で有効活用する開発投資)
    - [技術開発の未来像を提示](#技術開発の未来像を提示)
...
2. ERP(経営資源管理)
**情報システムにより、企業内の期間業務を連係させて統合的に管理し、全体規模で最適化された企業活動を実現**しようとする管理手法および実現のためのシステム。

3. SFA(営業支援)
**顧客の情報や取引の履歴などをデータとして蓄積し、営業部全体で利用するための仕組みを備えた営業支援システム**。
担当者が変わっても継続的に顧客を確保するのが目的。

4. CRM(顧客関係管理)
**一元管理された顧客データベースの活用により、顧客満足度向上と有料顧客の固定化**を図るための管理およびシステム。

5. SCM(供給連鎖管理)
**SCM**とは製品の製造や販売における管理で、**SCMシステム**とは、**取引先との受発注、部品や資材の調達~生産、物流までの流れを管理・最適化して、在庫コストや流通コストの削減を行う**ためのシステム。

## 開発競争に負けない技術開発戦略

- 技術開発戦略
経営戦略に基づいて将来に向けた投資目標を定めていく。

![](2022-10-11-14-24-41.png)
...
- 技術ロードマップ
**将来における技術分野の進展を予測し**、「どんな技術が、いつ達成されるのか、その実現によってどんな影響(効果)がもたらされるのか」を**時系列で実現したロードマップのこと**。

- 技術のSカープ
**新しい技術は、開発当初は緩やかに進歩するが、ある時からは急激に発展し、やがて停滞していく**という理論のこと。
